using Dashi: Observable, Retain, CacheKey, decode_extension_and_addbits
using Dashi, MsgPack, Test
...
@testset "MsgPack" begin
    ...
    unpacked = Dashi.decode_extension_and_addbits(MsgPack.unpack(MsgPack.pack(data)))

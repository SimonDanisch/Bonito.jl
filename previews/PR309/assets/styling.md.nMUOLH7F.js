...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p>All Bonito components are stylable this way.</p><div class="tip custom-block"><p class="custom-block-title">Info</p><p>Why not <code>Hyperscript.Style</code>? While the scoped styling via <code>Hyperscript.Style</code> is great, it makes it harder to create stylable components, since it doesn&#39;t allow the deduplication of CSS objects across the session. It&#39;s also significantly slower, since it&#39;s not as specialized on the deduplication and the camelcase keyword to css attribute conversion is pretty costly. That&#39;s also why <code>CSS</code> uses pairs of strings instead of keyword arguments.</p></div>`,7)),l(t,{type:"info",class:"source-link",text:"source"},{default:d(()=>s[2]||(s[2]=[i("a",{href:"https://github.com/SimonDanisch/Bonito.jl/blob/90005104a30d892e9857603c318b667514628e0d/src/types.jl#L125-L151",target:"_blank",rel:"noreferrer"},"source",-1)])),_:1})]),s[7]||(s[7]=n(`<h2 id="Using-CSS-and-pseudo-classes" tabindex="-1">Using CSS and pseudo classes <a class="header-anchor" href="#Using-CSS-and-pseudo-classes" aria-label="Permalink to &quot;Using CSS and pseudo classes {#Using-CSS-and-pseudo-classes}&quot;">​</a></h2><p>The <code>CSS</code> object allows to specify a selector, which will be used to apply the styling to a specific DOM node. Since the main usage is to apply the <code>Style</code> object to a <code>DOM</code> node, the selector is usually empty and we use it mainly for pseudo classes like <code>:hover</code>:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">App</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">do</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> session</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div><div>
  <div class="bonito-fragment" id="4f1a5859-cf9b-46ae-a701-0542b8e46270" data-jscall-id="root">
    <div>
    ...
    <div>
      <script type="module">Bonito.lock_loading(() => Bonito.init_session('4f1a5859-cf9b-46ae-a701-0542b8e46270', null, 'root', false))<\/script>
      <span></span>
    </div>
  </div>
  <div class="bonito-fragment" id="f14d1396-88e1-4ca3-afc0-aa5020c0c43d" data-jscall-id="subsession-application-dom">
    <div>
      <style>.style_2:hover {
  color: red;
  text-size: 2rem;
    ...
    <div>
      <script type="module">Bonito.lock_loading(() => Bonito.init_session('f14d1396-88e1-4ca3-afc0-aa5020c0c43d', null, 'sub', false))<\/script>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div><div class="bonito-fragment" id="1802f6b8-1f76-47b7-a7b4-114b8116eb82" data-jscall-id="subsession-application-dom">
  <div>
    <style>.style_3:hover {
...
.style_5:focus {
  ...
  <div>
    <script type="module">Bonito.lock_loading(() => Bonito.init_session('1802f6b8-1f76-47b7-a7b4-114b8116eb82', null, 'sub', false))<\/script>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div><div class="bonito-fragment" id="826968e5-ef93-4566-bda4-56f1379d1ada" data-jscall-id="subsession-application-dom">
  <div>
    <style>.style_6:focus {
  outline-offset: 1px;
...
.style_8:hover {
  ...
  <div>
    <script type="module">    Bonito.lock_loading(() => {
        return Bonito.fetch_binary('bonito/bin/d89ec0693a4477b4de27545dd91086d33328ebf4-15766218174228229812.bin').then(msgs=> Bonito.init_session('826968e5-ef93-4566-bda4-56f1379d1ada', msgs, 'sub', false));
    })
<\/script>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        )</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    )</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div><div class="bonito-fragment" id="98107f8f-52aa-4b7e-8c7f-d9e0024a7c94" data-jscall-id="subsession-application-dom">
  <div>
    <style></style>
    <div></div>
  </div>
  <div>
    <script type="module">Bonito.lock_loading(() => Bonito.init_session('98107f8f-52aa-4b7e-8c7f-d9e0024a7c94', null, 'sub', false))<\/script>

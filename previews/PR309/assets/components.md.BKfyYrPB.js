import{_ as i,c as a,o as l,aA as t}from"./chunks/framework.FpaCczW1.js";const r=JSON.parse('{"title":"Components","description":"","frontmatter":{},"headers":[],"relativePath":"components.md","filePath":"components.md","lastUpdated":null}'),n={name:"components.md"};function d(e,s,h,p,y,c){return l(),a("div",null,s[0]||(s[0]=[t(`<h1 id="components" tabindex="-1">Components <a class="header-anchor" href="#components" aria-label="Permalink to &quot;Components&quot;">​</a></h1><p>Components in Bonito are meant to be re-usable, easily shareable types and functions to create complex Bonito Apps. We invite everyone to share their Components by turning them into a Julia library.</p><p>There are two ways of defining components in Bonito:</p><ol><li><p>Write a function which returns <code>DOM</code> objects</p></li><li><p>Overload <code>jsrender</code> for a type</p></li></ol><p>The first is a very lightweight form of defining reusable components, which should be preferred if possible.</p><p>But, for e.g. widgets the second form is unavoidable, since you will want to return a type that the user can register interactions with. Also, the second form is great for integrating existing types into Bonito like plot objects. How to do the latter for Plotly is described in <a href="/Bonito.jl/previews/PR309/plotting#Plotting">Plotting</a>.</p><p>Let&#39;s start with the simple function based components that reuses existing Bonito components:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Dates</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">App</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(()</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-&gt;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> CurrentMonth</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">())</span></span></code></pre></div><div><div>
  <div class="bonito-fragment" id="ad1516b7-33e7-435d-bed0-898e810bbed3" data-jscall-id="root">
    <div>
    ...
    <div>
      <script type="module">Bonito.lock_loading(() => Bonito.init_session('ad1516b7-33e7-435d-bed0-898e810bbed3', null, 'root', false))<\/script>
      <span></span>
    </div>
  </div>
  <div class="bonito-fragment" id="e071c3d6-ede8-47b4-a55f-b6d2a151e95c" data-jscall-id="subsession-application-dom">
    <div>
      <style>.style_2 {
...
.style_6 {
  ...
  margin: 2px;
    ...
    <div>
      <script type="module">Bonito.lock_loading(() => Bonito.init_session('e071c3d6-ede8-47b4-a55f-b6d2a151e95c', null, 'sub', false))<\/script>
      <div class=" style_3" style="" data-jscall-id="1">
        ...
        <div class=" style_4" style="" data-jscall-id="3">
          ...
          <div class=" style_6" style="" data-jscall-id="32">
          ...
          <div class=" style_5" style="" data-jscall-id="52">
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div><div class="bonito-fragment" id="6f1483b3-fd88-4a53-a80e-50bc5ce3d486" data-jscall-id="subsession-application-dom">
  <div>
    <style>.style_7 {
  justify-items: center;
  align-items: center;
...
.style_11 {
  ...
  <div>
    <script type="module">Bonito.lock_loading(() => Bonito.init_session('6f1483b3-fd88-4a53-a80e-50bc5ce3d486', null, 'sub', false))<\/script>
    <div data-jscall-id="66">
      <div class=" style_8" style="" data-jscall-id="67">
        ...
        <div class=" style_9" style="" data-jscall-id="69">
          ...
          <div class=" style_11" style="" data-jscall-id="98">
          ...
          <div class=" style_10" style="" data-jscall-id="118">
...
</div></div><p>Please note, that <code>jsrender</code> is not applied recursively on its own, so one needs to apply it manually on the return value. It&#39;s not needed for simple divs and other Hyperscript elements, but e.g. <code>Styles</code> requires a pass through <code>jsrender</code> to do the deduplication etc.</p>`,13)]))}const v=i(n,[["render",d]]);export{r as __pageData,v as default};

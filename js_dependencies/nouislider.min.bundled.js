"use strict";
(() => {
  // ../../../../../Programmieren/MakieDev/dev/Bonito/js_dependencies/nouislider.min.js
  var N;
  (function(r) {
  ...
  function me(r) {
    return r.filter(function(t) {
      return this[t] ? false : this[t] = true;
    }, {});
  }
  function ge(r, t) {
  ...
  var jt = function() {
    function r(t, n, f) {
      this.xPct = [], this.xVal = [], this.xSteps = [], this.xNumSteps = [], this.xHighestCompleteStep = [], this.xSteps = [f || false], this.xNumSteps = [false], this.snap = n;
      var u, p = [];
    ...
    return r.prototype.getDistance = function(t) {
      ...
      var n = T(t, this.xPct);
      return { stepBefore: { startValue: this.xVal[n - 2], step: this.xNumSteps[n - 2], highestStep: this.xHighestCompleteStep[n - 2] }, thisStep: { startValue: this.xVal[n - 1], step: this.xNumSteps[n - 1], highestStep: this.xHighestCompleteStep[n - 1] }, stepAfter: { startValue: this.xVal[n], step: this.xNumSteps[n], highestStep: this.xHighestCompleteStep[n] } };
      ...
      var u = Number(n[1]);
      f ? this.xSteps.push(isNaN(u) ? false : u) : isNaN(u) || (this.xSteps[0] = u), this.xHighestCompleteStep.push(0);
      ...
      if (n) {
        ...
        this.xSteps[t] = pt([this.xVal[t], this.xVal[t + 1]], n, 0) / mt(this.xPct[t], this.xPct[t + 1]);
  ...
  function _e(r, t) {
    ...
    r.spectrum = new jt(t, r.snap || false, r.singleStep);
  }
  function Oe(r, t) {
  ...
  function je(r, t) {
    var n = [false], f;
    if (t === "lower" ? t = [true, false] : t === "upper" && (t = [false, true]), t === true || t === false) {
  ...
  function Be(r, t) {
    ...
    if (t !== 0) {
      for (Array.isArray(t) || (t = [t, t]), r.padding = [r.spectrum.getDistance(t[0]), r.spectrum.getDistance(t[1])], n = 0; n < r.spectrum.xNumSteps.length - 1; n++) if (r.padding[0][n] < 0 || r.padding[1][n] < 0) throw new Error("noUiSlider: 'padding' option must be a positive number(s).");
  ...
  function qe(r, t) {
    ...
    r.events = { tap: n || p, drag: f, dragAll: v, smoothSteps: U, fixed: u, snap: p, hover: d, unconstrained: b };
  }
  function Ie(r, t) {
    if (t !== false) if (t === true || $(t)) {
      r.tooltips = [];
  ...
  function Bt(r) {
    var t = { margin: null, limit: null, padding: null, animate: true, animationDuration: 300, ariaFormat: zt, format: zt }, n = { step: { r: false, t: ye }, keyboardPageMultiplier: { r: false, t: Me }, keyboardMultiplier: { r: false, t: Ue }, keyboardDefaultStep: { r: false, t: Le }, start: { r: true, t: Oe }, connect: { r: true, t: je }, direction: { r: true, t: Ke }, snap: { r: false, t: He }, animate: { r: false, t: ze }, animationDuration: { r: false, t: Re }, range: { r: true, t: _e }, orientation: { r: false, t: Fe }, margin: { r: false, t: Nt }, limit: { r: false, t: Ne }, padding: { r: false, t: Be }, behaviour: { r: true, t: qe }, ariaFormat: { r: false, t: Xe }, format: { r: false, t: Ye }, tooltips: { r: false, t: Ie }, keyboardSupport: { r: true, t: We }, documentElement: { r: false, t: Ge }, cssPrefix: { r: true, t: Je }, cssClasses: { r: true, t: Ze }, handleAttributes: { r: false, t: Te } }, f = { connect: false, direction: "ltr", behaviour: "tap", orientation: "horizontal", keyboardSupport: true, cssPrefix: "noUi-", cssClasses: Ft, keyboardPageMultiplier: 5, keyboardMultiplier: 1, keyboardDefaultStep: 10 };
  ...
  function $e(r, t, n) {
    ...
    function gt(e, i) {
      return i ? j(e, t.cssClasses.connect) : false;
    }
    function It(e, i) {
    ...
    function Xt(e, i) {
      return !t.tooltips || !t.tooltips[i] ? false : j(e.firstChild, t.cssClasses.tooltip);
    }
    function St() {
    ...
    function xt() {
      rt(), V = v.map(Xt), ot("update" + F.tooltips, function(e, i, a) {
        if (!(!V || !t.tooltips) && V[i] !== false) {
          var s = e[i];
          t.tooltips[i] !== true && (s = t.tooltips[i].to(a[i])), V[i].innerHTML = s;
        }
      });
    }
    function Gt() {
      I("update" + F.aria), ot("update" + F.aria, function(e, i, a, s, l) {
        _.forEach(function(o) {
          var h = v[o], c = W(C, o, 0, true, true, true), x = W(C, o, 100, true, true, true), S = l[o], w = String(t.ariaFormat.to(a[o]));
    ...
    function Zt(e) {
      ...
      var a = Jt(e), s = {}, l = m.xVal[0], o = m.xVal[m.xVal.length - 1], h = false, c = false, x = 0;
      return a = me(a.slice().sort(function(S, w) {
        return S - w;
      })), a[0] !== l && (a.unshift(l), h = true), a[a.length - 1] !== o && (a.push(o), c = true), a.forEach(function(S, w) {
        ...
        for (Ut && (E = m.xNumSteps[w]), E || (E = D - y), D === void 0 && (D = y), E = Math.max(E, 1e-7), g = y; g <= D; g = i(g, E)) {
          for (k = m.toStepping(g), ut = k - x, yt = ut / (e.density || 1), vt = Math.round(yt), Mt = ut / vt, A = 1; A <= vt; A += 1) ct = x + A * Mt, s[ct.toFixed(5)] = [m.fromStepping(ct), 0];
          ht = a.indexOf(g) > -1 ? L.LargeValue : Ut ? L.SmallValue : L.NoValue, !w && h && g !== D && (ht = 0), g === D && c || (s[k.toFixed(5)] = [g, ht]), x = k;
        }
      }), s;
    }
    function $t(e, i, a) {
      var s, l, o = q.createElement("div"), h = (s = {}, s[L.None] = "", s[L.NoValue] = t.cssClasses.valueNormal, s[L.LargeValue] = t.cssClasses.valueLarge, s[L.SmallValue] = t.cssClasses.valueSub, s), c = (l = {}, l[L.None] = "", l[L.NoValue] = t.cssClasses.markerNormal, l[L.LargeValue] = t.cssClasses.markerLarge, l[L.SmallValue] = t.cssClasses.markerSub, l), x = [t.cssClasses.valueHorizontal, t.cssClasses.valueVertical], S = [t.cssClasses.markerHorizontal, t.cssClasses.markerVertical];
      ...
      function E(g, A, y) {
        if (y = i ? i(A, y) : y, y !== L.None) {
          var D = j(o, false);
          D.className = w(y, t.cssClasses.marker), D.style[t.style] = g + "%", y > L.NoValue && (D = j(o, false), D.className = w(y, t.cssClasses.value), D.setAttribute("data-value", String(A)), D.style[t.style] = g + "%", D.innerHTML = String(a.to(A)));
        }
      }
    ...
    function at(e) {
      it();
      var i = Zt(e), a = e.filter, s = e.format || { to: function(l) {
        return String(Math.round(l));
      } };
      return O = d.appendChild($t(i, a, s)), O;
    }
    function wt() {
      var e = b.getBoundingClientRect(), i = "offset" + ["Width", "Height"][t.ort];
      return t.ort === 0 ? e.width || b[i] : e.height || b[i];
    }
    function B(e, i, a, s) {
      var l = function(h) {
        var c = Qt(h, s.pageOffset, s.target || i);
        if (!c || St() && !s.doNotReject || be(d, t.cssClasses.tap) && !s.doNotReject || e === f.start && c.buttons !== void 0 && c.buttons > 1 || s.hover && c.buttons) return false;
        p || c.preventDefault(), c.calcPoint = c.points[t.ort], a(c, s);
      }, o = [];
      return e.split(" ").forEach(function(h) {
        i.addEventListener(h, l, p ? { passive: true } : false), o.push([h, l]);
      }), o;
    }
    function Qt(e, i, a) {
      var s = e.type.indexOf("touch") === 0, l = e.type.indexOf("mouse") === 0, o = e.type.indexOf("pointer") === 0, h = 0, c = 0;
      if (e.type.indexOf("MSPointer") === 0 && (o = true), e.type === "mousedown" && !e.buttons && !e.touches) return false;
      if (s) {
        var x = function(E) {
          var g = E.target;
      ...
      return i = i || Rt(q), (l || o) && (h = e.clientX + i.x, c = e.clientY + i.y), e.pageOffset = i, e.points = [h, c], e.cursor = l || o, e;
    }
    function Et(e) {
    ...
    function nt(e, i) {
      if (!i.handleNumbers.some(et)) {
        ...
        e.stopPropagation();
        var l = [], o = B(f.move, X, re, { target: e.target, handle: a, connect: i.connect, listeners: l, startCalcPoint: e.calcPoint, baseSize: wt(), pageOffset: e.pageOffset, handleNumbers: i.handleNumbers, buttonsProperty: e.buttons, locations: C.slice() }), h = B(f.end, X, st, { target: e.target, handle: a, listeners: l, doNotReject: true, handleNumbers: i.handleNumbers }), c = B("mouseout", X, ee, { target: e.target, handle: a, listeners: l, doNotReject: true, handleNumbers: i.handleNumbers });
        l.push.apply(l, o.concat(h, c)), e.cursor && (Y.style.cursor = getComputedStyle(e.target).cursor, v.length > 1 && M(d, t.cssClasses.drag), Y.addEventListener("selectstart", _t, false)), i.handleNumbers.forEach(function(x) {
          P("start", x);
        });
      }
    }
    function ie(e) {
      ...
      a !== false && (t.events.snap || Ot(d, t.cssClasses.tap, t.animationDuration), K(a, i, true, true), ft(), P("slide", a, true), P("update", a, true), t.events.snap ? nt(e, { handleNumbers: [a] }) : (P("change", a, true), P("set", a, true)));
    }
    function ae(e) {
    ...
    function se(e, i) {
      if (St() || et(i)) return false;
      var a = ["Left", "Right"], s = ["Down", "Up"], l = ["PageDown", "PageUp"], o = ["Home", "End"];
      ...
      if (!S && !w && !E && !g) return true;
      e.preventDefault();
      var A;
      if (w || S) {
        var y = S ? 0 : 1, D = kt(i), k = D[y];
        if (k === null) return false;
        k === false && (k = m.getDefaultStep(C[i], S, t.keyboardDefaultStep)), x || c ? k *= t.keyboardPageMultiplier : k *= t.keyboardMultiplier, k = Math.max(k, 1e-7), k = (S ? -1 : 1) * k, A = z[i] + k;
      } else g ? A = t.spectrum.xVal[t.spectrum.xVal.length - 1] : A = t.spectrum.xVal[0];
      return K(i, m.toStepping(A), true, true), P("slide", i), P("update", i), P("change", i), P("set", i), false;
    }
    function ne(e) {
      e.fixed || v.forEach(function(i, a) {
        B(f.start, i.children[0], nt, { handleNumbers: [a] });
      }), e.tap && B(f.start, b, ie, {}), e.hover && B(f.move, b, ae, { hover: true }), e.drag && U.forEach(function(i, a) {
        if (!(i === false || a === 0 || a === U.length - 1)) {
          var s = v[a - 1], l = v[a], o = [i], h = [s, l], c = [a - 1, a];
          M(i, t.cssClasses.draggable), e.fixed && (o.push(s.children[0]), o.push(l.children[0])), e.dragAll && (h = v, c = _), o.forEach(function(x) {
            B(f.start, x, nt, { handles: h, handleNumbers: c, connect: i });
          });
        }
      });
    }
    ...
    function P(e, i, a) {
      Object.keys(R).forEach(function(s) {
        ...
        e === l && R[s].forEach(function(o) {
          o.call(J, z.map(t.format.to), i, z.slice(), a || false, C.slice(), J);
        });
      });
    }
    function W(e, i, a, s, l, o, h) {
      var c;
      return v.length > 1 && !t.events.unconstrained && (s && i > 0 && (c = m.getAbsoluteDistance(e[i - 1], t.margin, false), a = Math.max(a, c)), l && i < v.length - 1 && (c = m.getAbsoluteDistance(e[i + 1], t.margin, true), a = Math.min(a, c))), v.length > 1 && t.limit && (s && i > 0 && (c = m.getAbsoluteDistance(e[i - 1], t.limit, false), a = Math.min(a, c)), l && i < v.length - 1 && (c = m.getAbsoluteDistance(e[i + 1], t.limit, true), a = Math.max(a, c))), t.padding && (i === 0 && (c = m.getAbsoluteDistance(0, t.padding[0], false), a = Math.max(a, c)), i === v.length - 1 && (c = m.getAbsoluteDistance(100, t.padding[1], true), a = Math.min(a, c))), h || (a = m.getStep(a)), a = Ht(a), a === e[i] && !o ? false : a;
    }
    function lt(e, i) {
      var a = t.ort;
      return (a ? i : e) + ", " + (a ? e : i);
    ...
    function Ct(e, i, a, s, l) {
      var o = a.slice(), h = s[0], c = t.events.smoothSteps, x = [!e, e], S = [e, !e];
      s = s.slice(), e && s.reverse(), s.length > 1 ? s.forEach(function(E, g) {
        var A = W(o, E, o[E] + i, x[g], S[g], false, c);
        A === false ? i = 0 : (i = A - o[E], o[E] = A);
      }) : x = S = [true];
      var w = false;
      s.forEach(function(E, g) {
        w = K(E, a[E] + i, x[g], S[g], false, c) || w;
    ...
    function K(e, i, a, s, l, o) {
      return l || (i = W(C, e, i, a, s, false, o)), i === false ? false : (le(e, i), true);
    }
    function At(e) {
      if (U[e]) {
        var i = 0, a = 100;
    ...
    function Vt(e, i) {
      return e === null || e === false || e === void 0 || (typeof e == "number" && (e = String(e)), e = t.format.from(e), e !== false && (e = m.toStepping(e)), e === false || isNaN(e)) ? C[i] : e;
    }
    function G(e, i, a) {
      var s = Q(e), l = C[0] === void 0;
      i = i === void 0 ? true : i, t.animate && !l && Ot(d, t.cssClasses.tap, t.animationDuration), _.forEach(function(c) {
        K(c, Vt(s[c], c), true, false, a);
      });
      var o = _.length === 1 ? 0 : 1;
      if (l && m.hasNoSize() && (a = true, C[0] = 0, _.length > 1)) {
    ...
    function ue(e, i, a, s) {
      ...
      K(e, Vt(i, e), true, true, s), P("update", e), a && P("set", e);
    }
    function Dt(e) {
      if (e === void 0 && (e = false), e) return z.length === 1 ? z[0] : z.slice(0);
    ...
    function kt(e) {
      ...
      if (t.snap) return [s - a.stepBefore.startValue || null, a.stepAfter.startValue - s || null];
      l !== false && s + l > a.stepAfter.startValue && (l = a.stepAfter.startValue - s), s > a.thisStep.startValue ? o = a.thisStep.step : a.stepBefore.step === false ? o = false : o = s - a.stepBefore.highestStep, i === 100 ? l = null : i === 0 && (o = null);
      var h = m.countStepDecimals();
      return l !== null && l !== false && (l = Number(l.toFixed(h))), o !== null && o !== false && (o = Number(o.toFixed(h))), [o, l];
    }
    function he() {
      return _.map(kt);
    }
    function ve(e, i) {
      var a = Dt(), s = ["margin", "limit", "padding", "range", "animate", "snap", "step", "format", "pips", "tooltips"];
    ...
    de();
    var J = { destroy: ce, steps: he, on: ot, off: I, get: Dt, set: G, setHandle: ue, reset: fe, disable: Yt, enable: Wt, __moveHandles: function(e, i, a) {
      Ct(e, i, C, a);
    }, options: n, updateOptions: ve, target: d, removePips: it, removeTooltips: rt, getPositions: function() {
      return C.slice();
  ...
  var tr = { __spectrum: jt, cssClasses: Ft, create: Qe };
})();

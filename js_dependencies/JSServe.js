import { encode as msg_encode, decode as msg_decode } from "./msgpack.min.js";
import { inflate } from "./pako_inflate.min.js";
...
async function base64decode(data) {
    ...
    const base64url = reader.readAsDataURL(new Blob([data]));
    /*
